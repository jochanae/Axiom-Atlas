...
export default function Projects() {
  ...
  const handleCommitProject = useCallback(async (id: number) => {
    ...
    try {
      ...
      setCreateError("Failed to commit project.");
    } finally {
  ...
  const selectedTab = PROJECT_STATUS_TABS.find(tab => tab.value === activeTab);
  ...
  return (
    ...
    >
      ...
      <main style={{ flex: 1, padding: "20px 16px 120px", maxWidth: 760, width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        ...
        ) : projectCount === 0 && archivedProjects.length === 0 ? (
          <div style={{
            marginTop: 60,
          ...
          <>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "8px 12px",
                      borderRadius: 7,
                      border: `1px solid ${selected ? "rgba(201,162,76,0.45)" : "var(--atlas-border)"}`,
                      background: selected ? "rgba(201,162,76,0.12)" : "rgba(255,255,255,0.02)",
                    ...
                    onMouseEnter={(e) => {
                      if (!selected) {
                        e.currentTarget.style.borderColor = "rgba(201,162,76,0.28)";
            ...
            {visibleProjects.length === 0 ? (
              <div style={{
                ...
                <p style={{ ...sMono, fontSize: 11, color: "var(--atlas-muted)", letterSpacing: "0.08em", margin: 0 }}>
                  No {selectedTab?.label.toLowerCase()} projects.
                </p>
              </div>
            ) : (
      ...
      {!confirmDelete && onCommit && (
        <button
          ...
          style={{
            ...
            background: committing ? "rgba(201,162,76,0.05)" : "rgba(201,162,76,0.09)",
          ...
          onMouseEnter={(e) => {
            if (!committing) {
              ...
              e.currentTarget.style.borderColor = "rgba(201,162,76,0.5)";
            }
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = committing ? "rgba(201,162,76,0.05)" : "rgba(201,162,76,0.09)";
